...
| Project | Security & Tech Stack | Description |
|:---|:---|:---|
| **[Password Toolkit](https://github.com/effjy/entropy/)** | [![Language: C](https://img.shields.io/badge/Language-C-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/entropy) <br> [![CSPRNG: getrandom()](https://img.shields.io/badge/CSPRNG-getrandom()-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/entropy) <br> [![Status: Stable](https://img.shields.io/badge/Status-Stable-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/entropy/) | CSPRNG-backed password generator with an entropy analyzer that penalizes repeated chars, sequences, and dictionary coverage. |
| **[Password Toolkit GUI](https://github.com/effjy/entropy-gui/)** | [![Language: C](https://img.shields.io/badge/Language-C-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/entropy-gui) <br> [![GUI: GTK3](https://img.shields.io/badge/GUI-GTK3.0-8a2be2?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/entropy-gui) <br> [![CSPRNG: getrandom()](https://img.shields.io/badge/CSPRNG-getrandom()-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/entropy-gui) <br> [![Status: Stable](https://img.shields.io/badge/Status-Stable-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/entropy-gui/) | GTK3 desktop app for password security: analyzes naive vs. realistic entropy (penalizing repeats, sequences, dictionary words, and leet-speak) and generates strong passwords via a `getrandom()` CSPRNG, with a color-coded strength meter and one-click clipboard copy. |
...
| **[Syshash](https://github.com/effjy/syshash/)** | [![Language: C](https://img.shields.io/badge/Language-C-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/syshash) <br> [![Hash: SHA3-512](https://img.shields.io/badge/Hash-SHA3--512-8a2be2?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/syshash) <br> [![Status: Stable](https://img.shields.io/badge/Status-Stable-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/syshash/) | Interactive file integrity monitor that recursively hashes a directory with SHA3-512 and detects content changes on subsequent runs. |
| **[Sizer](https://github.com/effjy/sizer)** | [![Language: C](https://img.shields.io/badge/Language-C-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/sizer) <br> [![GUI: GTK3](https://img.shields.io/badge/GUI-GTK3.0-8a2be2?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/sizer) <br> [![Status: Stable](https://img.shields.io/badge/Status-Stable-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/sizer) | GTK3 disk space analyzer that scans from `/` (or any directory) and reports the largest files and folders with live percentages, in-cell percentage bars, and an interactive donut diagram. Threaded scanning keeps the UI responsive with a live progress bar and cancel button, plus drill-down navigation and human-readable sizes. |
</details>
...
| **[Krakken Harness](https://github.com/effjy/krakken-harness/)** | [![License: MIT](https://img.shields.io/badge/License-MIT-teal?style=flat-square&labelColor=1a1a1a)](LICENSE) <br> [![Language: C](https://img.shields.io/badge/Language-C-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/krakken-harness) <br> [![Tests: 18/18](https://img.shields.io/badge/Tests-18%2F18-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/krakken-harness) <br> [![KAT: Pinned](https://img.shields.io/badge/KAT-Pinned-8a2be2?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/krakken-harness) | Standalone regression & correctness harness for the **Krakken-2048** permutation and Krakken-Disk **V5** storage format — pinned KAT, per-round avalanche measurement, and on-disk tamper / nonce-reuse checks. One `make run`, libsodium the only dependency. |
<br>
