...
| **[Syshash](https://github.com/effjy/syshash/)** | [![Language: C](https://img.shields.io/badge/Language-C-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/syshash) <br> [![Hash: SHA3-512](https://img.shields.io/badge/Hash-SHA3--512-8a2be2?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/syshash) <br> [![Status: Stable](https://img.shields.io/badge/Status-Stable-teal?style=flat-square&labelColor=1a1a1a)](https://github.com/effjy/syshash/) | Lightweight interactive file integrity monitor — recursively hashes a directory tree with **SHA3-512** (Keccak-f[1600], implemented from scratch, zero dependencies) and stores results in a flat-file database. On subsequent runs, detects content changes and lets you accept or reject each one individually or in batch. |
</details>
