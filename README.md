...
| <div align="center"><a href="https://github.com/effjy/pq-audit/"><img src="titles/pq-audit-title.svg" height="52" alt="PQ-AUDIT"></a></div> | Forward-secure, hash-chained audit log with post-quantum (ML-DSA/SLH-DSA) seals and Merkle proofs. |
| <div align="center"><a href="https://github.com/effjy/pq-sealed/"><img src="titles/pq-sealed-title.svg" height="52" alt="PQ-Sealed"></a></div> | Post-quantum encrypted, deduplicating backups — content-addressed snapshots sealed with a Kyber-1024/X448 hybrid KEM and ML-DSA-signed manifests. |
...
| <div align="center"><a href="https://github.com/effjy/pqotp/"><img src="titles/pqotp-title.svg" height="52" alt="PQOTP"></a></div> | Post-quantum 2FA authenticator: TOTP/HOTP seeds under one master password. |
...
| <div align="center"><a href="https://github.com/effjy/mole/"><img src="titles/mole-title.svg" height="52" alt="Mole"></a></div> | Recursively searches a codebase for exposed secrets like API keys, tokens, and passwords, then lets you work through the matches in either a CLI for pipelines and CI or a GTK3 triage interface built for fast manual review. |
